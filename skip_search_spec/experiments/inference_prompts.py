...
INFERENCE_TEST_PROMPTS_OPEN_ENDED = [
    ("normal_remote_work", "What are some benefits and drawbacks of remote work for a small software team?\n\n"),
    ("normal_sleep_habits", "Explain how sleep habits can affect focus, mood, and learning during a busy week.\n\n"),
    ("normal_city_noise", "Why do some people find city noise energizing while others find it exhausting?\n\n"),
    ("normal_building_habits", "Give practical advice for building a new habit without relying only on motivation.\n\n"),
    ("normal_public_transport", "Discuss what makes public transportation convenient or inconvenient for everyday commuters.\n\n"),
    ("normal_language_learning", "Explain several ways an adult can make steady progress when learning a new language.\n\n"),
    ("normal_home_cooking", "Why can cooking at home feel satisfying even when it takes more time than ordering food?\n\n"),
    ("normal_team_trust", "How can trust develop in a team where people have different working styles?\n\n"),
    ("normal_feedback", "Describe what makes feedback useful rather than discouraging.\n\n"),
    ("normal_books_movies", "How does experiencing a story as a book differ from experiencing it as a film?\n\n"),
    ("compare_laptop_tablet", "Compare using a laptop and a tablet for schoolwork, including comfort, flexibility, and limitations.\n\n"),
    ("compare_renting_buying", "Compare renting an apartment with buying a home from the perspective of a young professional.\n\n"),
    ("compare_company_size", "What are the tradeoffs between working at a small company and working at a large company?\n\n"),
    ("compare_online_class", "Compare online classes and in-person classes for a student who wants both structure and flexibility.\n\n"),
    ("compare_morning_evening", "Compare doing focused work in the morning with doing focused work in the evening.\n\n"),
    ("compare_paper_digital_notes", "What are the advantages and disadvantages of taking notes on paper versus using a digital app?\n\n"),
    ("compare_city_suburb", "Compare living in a dense city center with living in a quieter suburb.\n\n"),
    ("compare_sports", "Compare individual sports and team sports in terms of motivation, pressure, and enjoyment.\n\n"),
    ("compare_cooking_restaurant", "Compare cooking dinner at home with going to a restaurant for a casual evening with friends.\n\n"),
    ("compare_planning_improvising", "When is careful planning useful, and when can improvising lead to better results?\n\n"),
    ("advice_first_apartment", "Give advice to someone moving into their first apartment and trying to make it feel comfortable on a budget.\n\n"),
    ("advice_new_manager", "What should a new manager do during the first month with a team they just inherited?\n\n"),
    ("advice_exam_stress", "Suggest ways for a student to handle exam stress while still studying effectively.\n\n"),
    ("advice_friend_moving", "What could you say to a close friend who is nervous about moving to a new city?\n\n"),
    ("advice_saving_money", "Give realistic advice for saving money without making daily life feel joyless.\n\n"),
    ("advice_running", "How should a complete beginner start running without overdoing it in the first few weeks?\n\n"),
    ("advice_public_speaking", "Give advice to someone who gets nervous before speaking in front of a group.\n\n"),
    ("advice_work_conflict", "How can a person handle a small workplace conflict before it becomes a larger problem?\n\n"),
    ("advice_creative_block", "Suggest ways to get unstuck when a creative project has started to feel flat.\n\n"),
    ("advice_home_office", "Give suggestions for setting up a small home office in a shared apartment.\n\n"),
    ("plan_weekend_visit", "Plan a relaxed weekend itinerary for a friend visiting your city for the first time.\n\n"),
    ("plan_dinner_party", "Plan a simple dinner party for six people, including food, timing, and atmosphere.\n\n"),
    ("plan_study_week", "Create a one-week study plan for someone preparing for a difficult exam.\n\n"),
    ("plan_moving_day", "Outline a moving-day plan that reduces stress and keeps the important tasks organized.\n\n"),
    ("plan_book_club", "Describe how to start a small book club that people will actually keep attending.\n\n"),
    ("plan_phone_free_day", "Plan a day without using a phone, including what might be difficult and what might be refreshing.\n\n"),
    ("plan_team_offsite", "Suggest an agenda for a one-day team offsite focused on planning and team connection.\n\n"),
    ("plan_balcony_garden", "Plan a small balcony garden for someone who has little experience with plants.\n\n"),
    ("plan_budget_trip", "Plan a short budget trip for two friends who care more about food and walking around than sightseeing.\n\n"),
    ("plan_research_project", "Outline the first steps for a student starting a research project with a broad topic and limited time.\n\n"),
    ("email_late_delivery", "Draft a polite email asking about a delayed delivery without sounding angry.\n\n"),
    ("email_reschedule_meeting", "Write an email asking to reschedule a meeting because another commitment came up.\n\n"),
    ("email_thank_you", "Draft a thank-you email after someone gave useful career advice.\n\n"),
    ("email_neighbor_noise", "Write a friendly message to a neighbor about late-night noise.\n\n"),
    ("email_job_followup", "Draft a follow-up email after a job interview that sounds interested but not pushy.\n\n"),
    ("message_cancel_plans", "Write a text message to a friend cancelling plans because you are exhausted, while showing you still care.\n\n"),
    ("announcement_event", "Write a short announcement for a community event that should feel welcoming rather than formal.\n\n"),
    ("product_update", "Write a product update explaining a useful new feature to existing users.\n\n"),
    ("support_reply", "Write a calm customer support reply to someone confused about a billing change.\n\n"),
    ("workshop_invitation", "Draft an invitation to a writing workshop for beginners who may feel intimidated.\n\n"),
    ("summarize_park_passage", "Passage: The city opened a new riverside park with walking paths, sports fields, playgrounds, and restored wetlands. Officials hope it will give residents more outdoor space while also improving flood protection during heavy rain.\n\nSummary:\n"),
    ("summarize_school_passage", "Passage: A local school changed its schedule so students start later in the morning. Teachers reported better attendance in first-period classes, but some families said the new schedule made after-school logistics harder.\n\nSummary:\n"),
    ("summarize_startup_passage", "Passage: A small startup stopped chasing many customer segments and focused on one group of users instead. The change reduced short-term revenue, but the team said it made product decisions clearer and support requests easier to understand.\n\nSummary:\n"),
    ("summarize_climate_passage", "Passage: The report argues that adapting to hotter summers will require more shade, better building insulation, expanded cooling centers, and changes to work schedules for outdoor jobs.\n\nSummary:\n"),
    ("summarize_museum_passage", "Passage: The museum redesigned its main exhibit to include more personal stories, interactive displays, and objects from local families. Visitors now spend more time in the space, though some longtime members miss the older layout.\n\nSummary:\n"),
    ("summarize_health_app", "Passage: A health app added reminders, weekly trend summaries, and a feature for sharing progress with a doctor. Early users liked the summaries but said the reminders needed more customization.\n\nSummary:\n"),
    ("summarize_work_policy", "Passage: A company introduced a four-day workweek trial for three months. Employees reported better focus and less burnout, while managers said project planning had to become more disciplined.\n\nSummary:\n"),
    ("summarize_restaurant_review", "Passage: The restaurant has a small menu, friendly service, and excellent bread, but the main dishes are inconsistent. It is a pleasant place for a casual meal, though probably not worth a special trip.\n\nSummary:\n"),
    ("summarize_research_note", "Passage: The study found that students remembered material better when they explained concepts in their own words instead of rereading notes. The effect was strongest when students received feedback soon afterward.\n\nSummary:\n"),
    ("summarize_podcast_episode", "Passage: The episode follows a carpenter who restores old furniture and talks about patience, mistakes, and the value of learning from materials that do not behave as expected.\n\nSummary:\n"),
    ("brainstorm_cafe", "Brainstorm ideas for a neighborhood cafe that feels useful during the day and cozy in the evening.\n\n"),
    ("brainstorm_app", "Brainstorm features for an app that helps people plan errands without making the day feel over-scheduled.\n\n"),
    ("brainstorm_workshop", "Brainstorm a practical workshop for adults who want to become more comfortable repairing things at home.\n\n"),
    ("brainstorm_newsletter", "Suggest possible sections for a weekly newsletter about small improvements to everyday life.\n\n"),
    ("brainstorm_board_game", "Brainstorm a board game concept about running a small town through changing seasons.\n\n"),
    ("brainstorm_class_project", "Brainstorm class project ideas for high school students studying local history.\n\n"),
    ("brainstorm_volunteer_event", "Brainstorm a volunteer event that would be easy for newcomers to join.\n\n"),
    ("brainstorm_museum_event", "Suggest ideas for a museum evening event aimed at people who do not usually visit museums.\n\n"),
    ("brainstorm_tiny_business", "Brainstorm a tiny business someone could run on weekends using skills they already have.\n\n"),
    ("brainstorm_podcast", "Brainstorm podcast ideas about ordinary jobs and the hidden expertise behind them.\n\n"),
    ("story_bob", "Tell a short story about Bob trying to fix a small mistake before anyone notices.\n\n"),
    ("story_bus_stop", "Write a short scene about two people waiting at a rainy bus stop.\n\n"),
    ("story_old_photo", "Tell a story about someone finding an old photo in a jacket pocket.\n\n"),
    ("story_bicycle", "Write a short story about a bicycle that means more to its owner than it first appears.\n\n"),
    ("story_lost_recipe", "Tell a story about a family trying to recreate a recipe no one wrote down properly.\n\n"),
    ("dialogue_roommates", "Write a dialogue between two roommates deciding how to divide chores more fairly.\n\n"),
    ("dialogue_barista", "Write a conversation between a barista and a regular customer who seems unusually distracted.\n\n"),
    ("dialogue_parent_teacher", "Write a respectful dialogue between a parent and teacher about a student who has stopped participating in class.\n\n"),
    ("dialogue_colleagues", "Write a conversation between two colleagues after a project presentation did not go as planned.\n\n"),
    ("dialogue_siblings", "Write a dialogue between adult siblings deciding what to do with objects from their childhood home.\n\n"),
    ("reflect_home", "Write a thoughtful paragraph about what can make a place feel like home.\n\n"),
    ("reflect_failure", "Reflect on why a failure can be embarrassing at first but useful later.\n\n"),
    ("reflect_waiting", "Write about the feeling of waiting for an important reply.\n\n"),
    ("reflect_attention", "Reflect on the difference between being busy and paying attention.\n\n"),
    ("reflect_routines", "Write about how small routines can make a stressful period easier to handle.\n\n"),
    ("analyze_decision", "Analyze how someone might decide whether to accept a secure job or pursue a riskier opportunity.\n\n"),
    ("analyze_design", "Analyze what makes a public bench, waiting room, or lobby feel welcoming rather than uncomfortable.\n\n"),
    ("analyze_policy", "Discuss possible effects of making all local buses free to ride.\n\n"),
    ("analyze_ai_tradeoffs", "Discuss some tradeoffs of using AI tools for writing, studying, and workplace communication.\n\n"),
    ("analyze_community", "Analyze what helps a neighborhood feel connected even when residents are busy.\n\n"),
    ("beginner_banks", "Explain to a beginner how banks make everyday payments, savings, and borrowing easier.\n\n"),
    ("beginner_privacy", "Explain digital privacy to a teenager using practical examples rather than technical jargon.\n\n"),
    ("beginner_technical_debt", "Explain technical debt to a non-technical manager without making it sound like laziness.\n\n"),
    ("beginner_internet", "Explain how the internet works to a curious ten-year-old.\n\n"),
    ("beginner_heat_pump", "Explain to a neighbor how a heat pump can move heat instead of creating it directly.\n\n"),
    ("outline_article_coffee", "Outline an article about why people build daily rituals around coffee or tea.\n\n"),
    ("outline_video_script", "Outline a short video script about preparing for the first day at a new job.\n\n"),
    ("outline_presentation", "Create an outline for a presentation about making meetings shorter and more useful.\n\n"),
    ("outline_blog_post", "Outline a blog post about learning a difficult skill as an adult.\n\n"),
    ("outline_short_course", "Outline a short course that teaches people how to make better everyday decisions.\n\n"),
]
